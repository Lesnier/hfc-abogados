    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white shadow-sm rounded-lg p-8">
        ...
        <p className="mb-4 text-gray-700">
          This privacy policy applies to the HFC Security Scanner app (hereby
          referred to as "Application") for mobile devices that was created by
          HFC Abogados (hereby referred to as "Service Provider") as a Free
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">
            ...
            identifiable information, including but not limited to email, CI,
            and name. The information that the Service Provider requests will be
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">
            ...
            <a
              href="mailto:info@hfcabogados.ar"
              className="text-blue-600 hover:text-blue-800 underline"
            >
              info@hfcabogados.ar
            </a>{" "}
